...
slider.addEventListener('mousemove', (e) => {
    ...
    const walk = (x - startX) * 0.9; // Ajuste a sensibilidade alterando o multiplicador (0.5)
...
slider2.addEventListener('mousemove', (e) => {
    ...
    const walk = (x - startX2) * 0.9; // Ajuste a sensibilidade alterando o multiplicador (0.5)
